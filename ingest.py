"""Build or rebuild the vector index from a folder of source documents.

This script reads each supported file, splits it into chunks, embeds the chunks,
and stores them in Chroma so the retriever can later answer questions.
"""
